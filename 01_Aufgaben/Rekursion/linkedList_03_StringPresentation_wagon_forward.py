...
class Wagon:
    ...
    # ==================================================================
    # String Ausgabe forwärts ermittelt
    # ==================================================================
    def __repr__(self):
        def repr_forward_rekursiv(self, values):
            if self.next is None:
                return f'{values}, {repr(self.value)}]'
            return repr_forward_rekursiv(self.next, f'{values}, {repr(self.value)}')
        values = f'{repr(self.value)}'
        return repr_forward_rekursiv(self.next, values)
